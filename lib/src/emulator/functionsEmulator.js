...
class FunctionsEmulator {
    ...
    static createHubServer(bundleTemplate, nodeBinary) {
        ...
        const backgroundHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const runtime = FunctionsEmulator.startFunctionRuntime(bundleTemplate, triggerId, functionsEmulatorShared_1.EmulatedTriggerType.BACKGROUND, nodeBinary, proto);
        ...
        const httpsHandler = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const reqBody = req.rawBody;
            const runtime = FunctionsEmulator.startFunctionRuntime(bundleTemplate, triggerId, functionsEmulatorShared_1.EmulatedTriggerType.HTTPS, nodeBinary);
            runtime.events.on("log", (el) => {
                if (el.level === "FATAL") {
...
function InvokeRuntime(nodeBinary, frb, opts) {
    ...
    const runtime = spawn(nodeBinary, args, {
        env: Object.assign(Object.assign({ node: nodeBinary }, opts.env), process.env),
        cwd: frb.cwd,
