...
describe("project", () => {
    ...
    describe("doSetup", () => {
        ...
        describe('with "Create a new project" option', () => {
            it("should create a new project and set up the correct properties", () => __awaiter(void 0, void 0, void 0, function* () {
                const options = {};
                const setup = { config: {}, rcfile: {} };
            ...
            it("should throw if project ID is empty after prompt", () => __awaiter(void 0, void 0, void 0, function* () {
                const options = {};
                const setup = { config: {}, rcfile: {} };
                promptOnceStub.onFirstCall().resolves("Create a new project");
                const fakePromptFn = (promptAnswer) => {
        ...
        describe('with "Add Firebase resources to GCP project" option', () => {
            it("should add firebase resources and set up the correct properties", () => __awaiter(void 0, void 0, void 0, function* () {
                const options = {};
                const setup = { config: {}, rcfile: {} };
                promptOnceStub
                    .onFirstCall()
        ...
        describe("with defined .firebaserc file", () => {
            ...
            it("should not prompt", () => __awaiter(void 0, void 0, void 0, function* () {
                yield project_1.doSetup(setup, {}, options);
