...
describe("createServiceAccountAndSetRoles", () => {
    ...
    it("should create a service account named ext-{instanceId} and set roles on it", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api.iamOrigin)
    ...
    it("should return a Firebase error if the accountId already exists", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api.iamOrigin)
            .post(`/${IAM_VERSION}/projects/${PROJECT_ID}/serviceAccounts`)
            .reply(409);
    ...
    it("should throw the caught error if its status is not 409", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api.iamOrigin)
            .post(`/${IAM_VERSION}/projects/${PROJECT_ID}/serviceAccounts`)
            .reply(500);
...
describe("grantRoles", () => {
    ...
    it("should add the desired roles to the service account, and not remove existing roles", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api.resourceManagerOrigin)
            .post(`/${RESOURCEMANAGER_VERSION}/projects/${PROJECT_ID}/:getIamPolicy`)
    ...
    it("should remove the chosen service account from the bindings for each roleToRemove", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api.resourceManagerOrigin)
            .post(`/${RESOURCEMANAGER_VERSION}/projects/${PROJECT_ID}/:getIamPolicy`)
            .reply(200, {
            bindings: [
