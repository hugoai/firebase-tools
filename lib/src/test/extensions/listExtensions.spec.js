...
describe("listExtensions", () => {
    ...
    it("should return an empty array if no extensions have been installed", () => __awaiter(void 0, void 0, void 0, function* () {
        listInstancesStub.returns(Promise.resolve([]));
        const result = yield listExtensions_1.listExtensions(PROJECT_ID);
        chai_1.expect(result).to.eql({ instances: [] });
    }));
    it("should return a sorted array of extension instances", () => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=listExtensions.spec.js.map