...
describe("generateInstanceId", () => {
    ...
    it("should return extensionSpec.name if no extension with that name exists yet", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should return extensionSpec.name plus a random string if a extension with that name exists", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should throw if it gets an unexpected error response from getInstance", () => __awaiter(void 0, void 0, void 0, function* () {
