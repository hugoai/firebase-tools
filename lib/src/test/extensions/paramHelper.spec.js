...
describe("paramHelper", () => {
    describe("getParams", () => {
        ...
        it("should read params from envFilePath if it is provided and is valid", () => __awaiter(void 0, void 0, void 0, function* () {
            dotenvStub.returns({
                A_PARAMETER: "aValue",
        ...
        it("should return the defaults for params that are not in envFilePath", () => __awaiter(void 0, void 0, void 0, function* () {
            dotenvStub.returns({
                A_PARAMETER: "aValue",
            });
            const params = yield paramHelper.getParams(PROJECT_ID, TEST_PARAMS, "./a/path/to/a/file.env");
        ...
        it("should throw if a param without a default is not in envFilePath", () => __awaiter(void 0, void 0, void 0, function* () {
            dotenvStub.returns({
        ...
        it("should warn about extra params provided in the env file", () => __awaiter(void 0, void 0, void 0, function* () {
            dotenvStub.returns({
                A_PARAMETER: "aValue",
                ANOTHER_PARAMETER: "default",
        ...
        it("should throw FirebaseError if an invalid envFilePath is provided", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should prompt the user for params if no env file is provided", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("promptForNewParams", () => {
        ...
        it("should prompt the user for any params in the new spec that are not in the current one", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should populate the spec with the default value if it is returned by prompt", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("shouldn't prompt if there are no new params", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should exit if a prompt fails", () => __awaiter(void 0, void 0, void 0, function* () {
