...
const throttlerTest = (throttlerConstructor) => {
    ...
    it("should resolve if task finishes before timeout", () => __awaiter(void 0, void 0, void 0, function* () {
        const handler = (task) => {
            return Promise.resolve(`result: ${task}`);
        };
    ...
    it("should reject if timeout", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should reject with RetriesExhaustedError if last trial is rejected before timeout", () => __awaiter(void 0, void 0, void 0, function* () {
        const handler = sinon.stub().rejects(TEST_ERROR);
        const q = new queue_1.default({
            handler,
            retries: 2,
    ...
    it("should reject with TimeoutError if timeout while retrying", () => __awaiter(void 0, void 0, void 0, function* () {
        const handler = sinon.stub().rejects(TEST_ERROR);
        const q = new queue_1.default({
            handler,
            retries: 1000,
    ...
    it("should reject with TimeoutError when waiting", () => __awaiter(void 0, void 0, void 0, function* () {
        const handler = sinon
            .stub()
            .rejects(TEST_ERROR)
            .onFirstCall()
    ...
    it("should reject with RetriesExhaustedError when waiting", () => __awaiter(void 0, void 0, void 0, function* () {
        const handler = sinon
            .stub()
            .rejects(TEST_ERROR)
            .onFirstCall()
