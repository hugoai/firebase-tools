...
describe("Project management", () => {
    ...
    describe("Interactive flows", () => {
        ...
        describe("getOrPromptProject", () => {
            it("should get project from list if it is able to list all projects", () => __awaiter(void 0, void 0, void 0, function* () {
                const options = {};
            ...
            it("should prompt project id if it is not able to list all projects", () => __awaiter(void 0, void 0, void 0, function* () {
                const options = {};
                apiRequestStub
                    .onFirstCall()
                    .resolves({
            ...
            it("should throw if there's no project", () => __awaiter(void 0, void 0, void 0, function* () {
                const options = {};
            ...
            it("should get the correct project info when --project is supplied", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it("should throw error when getFirebaseProject throw an error", () => __awaiter(void 0, void 0, void 0, function* () {
                const options = { project: "my-project-123" };
        ...
        describe("promptAvailableProjectId", () => {
            it("should select project from list if it is able to list all projects", () => __awaiter(void 0, void 0, void 0, function* () {
                apiRequestStub.onFirstCall().resolves({
                    body: {
    ...
    describe("API methods", () => {
        describe("createCloudProject", () => {
            it("should resolve with cloud project data if it succeeds", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it("should reject if Cloud project creation fails", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it("should reject if Cloud project creation polling throws error", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        describe("addFirebaseToCloudProject", () => {
            it("should resolve with Firebase project data if it succeeds", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it("should reject if add Firebase api call fails", () => __awaiter(void 0, void 0, void 0, function* () {
                const expectedError = new Error("HTTP Error 404: Not Found");
                apiRequestStub.onFirstCall().rejects(expectedError);
                let err;
                try {
            ...
            it("should reject if polling add Firebase operation throws error", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        describe("getAvailableCloudProjectPage", () => {
            it("should resolve with a project page if it succeeds (no input token)", () => __awaiter(void 0, void 0, void 0, function* () {
                const pageSize = 10;
            ...
            it("should resolve with a project page if it succeeds (with input token)", () => __awaiter(void 0, void 0, void 0, function* () {
                const pageSize = 10;
                const expectedProjectList = generateCloudProjectList(pageSize);
                apiRequestStub.onFirstCall().resolves({
                    body: { projectInfo: expectedProjectList, nextPageToken: NEXT_PAGE_TOKEN },
            ...
            it("should resolve with a project page if it succeeds with no next page token", () => __awaiter(void 0, void 0, void 0, function* () {
                const pageSize = 10;
            ...
            it("should reject if the api call fails", () => __awaiter(void 0, void 0, void 0, function* () {
                const pageSize = 100;
                const expectedError = new Error("HTTP Error 404: Not Found");
                apiRequestStub.onFirstCall().rejects(expectedError);
                let err;
        ...
        describe("listFirebaseProjects", () => {
            it("should resolve with project list if it succeeds with only 1 api call", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it("should concatenate pages to get project list if it succeeds with multiple api calls", () => __awaiter(void 0, void 0, void 0, function* () {
                const projectCounts = 10;
                const pageSize = 5;
            ...
            it("should reject if the first api call fails", () => __awaiter(void 0, void 0, void 0, function* () {
                const expectedError = new Error("HTTP Error 404: Not Found");
                apiRequestStub.onFirstCall().rejects(expectedError);
                let err;
                try {
            ...
            it("should reject if error is thrown in subsequence api call", () => __awaiter(void 0, void 0, void 0, function* () {
                const projectCounts = 10;
                const pageSize = 5;
                const nextPageToken = "next-page-token";
                const expectedProjectList = generateFirebaseProjectList(projectCounts);
        ...
        describe("getFirebaseProject", () => {
            it("should resolve with project information if it succeeds", () => __awaiter(void 0, void 0, void 0, function* () {
                const expectedProjectInfo = {
