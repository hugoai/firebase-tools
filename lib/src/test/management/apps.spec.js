...
describe("App management", () => {
    ...
    describe("createIosApp", () => {
        it("should resolve with app data if it succeeds", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should reject if app creation api call fails", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should reject if polling throws error", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("listFirebaseApps", () => {
        it("should resolve with app list if it succeeds with only 1 api call", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should resolve with iOS app list", () => __awaiter(void 0, void 0, void 0, function* () {
            const appCounts = 10;
        ...
        it("should resolve with Android app list", () => __awaiter(void 0, void 0, void 0, function* () {
            const appCounts = 10;
        ...
        it("should resolve with Web app list", () => __awaiter(void 0, void 0, void 0, function* () {
            const appCounts = 10;
        ...
        it("should concatenate pages to get app list if it succeeds", () => __awaiter(void 0, void 0, void 0, function* () {
            const appCountsPerPlatform = 3;
            const pageSize = 5;
        ...
        it("should rejects if error is thrown in subsequence api call", () => __awaiter(void 0, void 0, void 0, function* () {
            const appCounts = 10;
            const pageSize = 5;
            const nextPageToken = "next-page-token";
            const expectedAppList = generateAndroidAppList(appCounts);
        ...
        it("should reject if the list iOS apps fails", () => __awaiter(void 0, void 0, void 0, function* () {
            const expectedError = new Error("HTTP Error 404: Not Found");
            apiRequestStub.onFirstCall().rejects(expectedError);
            let err;
            try {
        ...
        it("should reject if the list Android apps fails", () => __awaiter(void 0, void 0, void 0, function* () {
            const expectedError = new Error("HTTP Error 404: Not Found");
            apiRequestStub.onFirstCall().rejects(expectedError);
            let err;
            try {
        ...
        it("should reject if the list Web apps fails", () => __awaiter(void 0, void 0, void 0, function* () {
            const expectedError = new Error("HTTP Error 404: Not Found");
            apiRequestStub.onFirstCall().rejects(expectedError);
            let err;
            try {
    ...
    describe("getAppConfig", () => {
        it("should resolve with iOS app configuration if it succeeds", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should resolve with Android app configuration if it succeeds", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should resolve with Web app configuration if it succeeds", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockWebConfig = {
        ...
        it("should reject if api request fails", () => __awaiter(void 0, void 0, void 0, function* () {
            const expectedError = new Error("HTTP Error 404: Not Found");
            apiRequestStub.onFirstCall().rejects(expectedError);
            let err;
            try {
