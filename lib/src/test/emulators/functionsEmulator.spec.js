...
function UseFunctions(triggers) {
    ...
    functionsEmulator_1.FunctionsEmulator.startFunctionRuntime = (bundleTemplate, triggerId, triggerType, nodeBinary, proto) => {
...
describe("FunctionsEmulator-Hub", () => {
    it("should route requests to /:project_id/:region/:trigger_id to HTTPS Function", () => __awaiter(void 0, void 0, void 0, function* () {
        UseFunctions(() => {
    ...
    it("should route requests to /:project_id/:region/:trigger_id/a/b to HTTPS Function", () => __awaiter(void 0, void 0, void 0, function* () {
        UseFunctions(() => {
            require("firebase-admin").initializeApp();
            return {
                function_id: require("firebase-functions").https.onRequest((req, res) => {
    ...
    it("should rewrite req.path to hide /:project_id/:region/:trigger_id", () => __awaiter(void 0, void 0, void 0, function* () {
        UseFunctions(() => {
            require("firebase-admin").initializeApp();
            return {
                function_id: require("firebase-functions").https.onRequest((req, res) => {
    ...
    it("should rewrite req.baseUrl to show /:project_id/:region/:trigger_id", () => __awaiter(void 0, void 0, void 0, function* () {
        UseFunctions(() => {
            require("firebase-admin").initializeApp();
            return {
                function_id: require("firebase-functions").https.onRequest((req, res) => {
    ...
    it("should route request body", () => __awaiter(void 0, void 0, void 0, function* () {
        UseFunctions(() => {
            require("firebase-admin").initializeApp();
            return {
                function_id: require("firebase-functions").https.onRequest((req, res) => {
    ...
    it("should route query parameters", () => __awaiter(void 0, void 0, void 0, function* () {
        UseFunctions(() => {
            require("firebase-admin").initializeApp();
            return {
                function_id: require("firebase-functions").https.onRequest((req, res) => {
