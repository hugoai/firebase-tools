...
describe("distribution", () => {
    ...
    describe("addReleaseNotes", () => {
        it("should return immediately when no release notes are specified", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("enableAccess", () => {
        it("should return immediately when testers and groups are empty", () => __awaiter(void 0, void 0, void 0, function* () {
            const apiSpy = sandbox.spy(api, "request");
