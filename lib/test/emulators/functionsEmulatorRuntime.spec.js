...
function InvokeRuntimeWithFunctions(frb, triggers, opts) {
    ...
    return functionsEmulator_1.InvokeRuntime(process.execPath, frb, Object.assign(Object.assign({}, opts), { serializedTriggers }));
}
...
describe("FunctionsEmulator-Runtime", () => {
    describe("Stubs, Mocks, and Helpers (aka Magic, Glee, and Awesomeness)", () => {
        describe("_InitializeNetworkFiltering(...)", () => {
            it("should log outgoing unknown HTTP requests via 'http'", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it("should log outgoing unknown HTTP requests via 'https'", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onCreate, () => {
                    require("firebase-admin").initializeApp();
                    return {
                        function_id: require("firebase-functions")
            ...
            it("should log outgoing Google API requests", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onCreate, () => {
                    require("firebase-admin").initializeApp();
                    return {
                        function_id: require("firebase-functions")
        ...
        describe("_InitializeFirebaseAdminStubs(...)", () => {
            it("should provide stubbed default app from initializeApp", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onCreate, () => {
                    require("firebase-admin").initializeApp();
                    return {
                        function_id: require("firebase-functions")
            ...
            it("should provide non-stubbed non-default app from initializeApp", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onCreate, () => {
                    require("firebase-admin").initializeApp();
            ...
            it("should route all sub-fields accordingly", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onCreate, () => {
                    require("firebase-admin").initializeApp();
                    return {
                        function_id: require("firebase-functions")
            ...
            it("should provide a stubbed Firestore through admin.firestore()", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onCreate, () => {
            ...
            it("should provide a stubbed Firestore through app.firestore()", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onCreate, () => {
                    const admin = require("firebase-admin");
            ...
            it("should provide the same stubs through admin-global or through the default app", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it("should expose Firestore prod when the emulator is not running", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it("should expose a stubbed Firestore when the emulator is running", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = _.cloneDeep(fixtures_1.FunctionRuntimeBundles.onRequest);
                frb.ports = {
                    firestore: 9090,
                };
            ...
            it("should expose RTDB prod when the emulator is not running", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = _.cloneDeep(fixtures_1.FunctionRuntimeBundles.onRequest);
                frb.ports = {};
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    const admin = require("firebase-admin");
            ...
            it("should expose a stubbed RTDB when the emulator is running", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = _.cloneDeep(fixtures_1.FunctionRuntimeBundles.onRequest);
                frb.ports = {
                    database: 9090,
                };
            ...
            it("should merge .settings() with emulator settings", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onCreate, () => {
                    const admin = require("firebase-admin");
                    admin.initializeApp();
            ...
            it("should merge .initializeApp arguments from user", () => __awaiter(void 0, void 0, void 0, function* () {
                if (process.env.CI) {
                    return;
                }
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onCreate, () => {
                    ...
                    return {
                        function_id: require("firebase-functions")
                            .firestore.document("test/test")
                            .onCreate((snap, ctx) => __awaiter(void 0, void 0, void 0, function* () {
                            admin
                                .database()
                                .ref("write-test")
                                .set({
        ...
        describe("_InitializeFunctionsConfigHelper()", () => {
            it("should tell the user if they've accessed a non-existent function field", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onCreate, () => {
                    require("firebase-admin").initializeApp();
                    return {
                        function_id: require("firebase-functions")
    ...
    describe("Runtime", () => {
        describe("HTTPS", () => {
            it("should handle a GET request", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = fixtures_1.FunctionRuntimeBundles.onRequest;
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    require("firebase-admin").initializeApp();
                    return {
                        function_id: require("firebase-functions").https.onRequest((req, res) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it("should handle a POST request with form data", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = fixtures_1.FunctionRuntimeBundles.onRequest;
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    require("firebase-admin").initializeApp();
                    return {
            ...
            it("should handle a POST request with JSON data", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = fixtures_1.FunctionRuntimeBundles.onRequest;
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    require("firebase-admin").initializeApp();
                    return {
            ...
            it("should handle a POST request with text data", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = fixtures_1.FunctionRuntimeBundles.onRequest;
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    require("firebase-admin").initializeApp();
                    return {
            ...
            it("should handle a POST request with any other type", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = fixtures_1.FunctionRuntimeBundles.onRequest;
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    require("firebase-admin").initializeApp();
                    return {
            ...
            it("should handle a POST request and store rawBody", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = fixtures_1.FunctionRuntimeBundles.onRequest;
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    require("firebase-admin").initializeApp();
                    return {
            ...
            it("should forward request to Express app", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = fixtures_1.FunctionRuntimeBundles.onRequest;
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    require("firebase-admin").initializeApp();
            ...
            it("should handle `x-forwarded-host`", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = fixtures_1.FunctionRuntimeBundles.onRequest;
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    require("firebase-admin").initializeApp();
                    return {
        ...
        describe("Cloud Firestore", () => {
            it("should provide Change for firestore.onWrite()", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onWrite, () => {
                    require("firebase-admin").initializeApp();
                    return {
                        function_id: require("firebase-functions")
                            .firestore.document("test/test")
                            .onWrite((change) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it("should provide Change for firestore.onUpdate()", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onUpdate, () => {
                    require("firebase-admin").initializeApp();
                    return {
                        function_id: require("firebase-functions")
                            .firestore.document("test/test")
                            .onUpdate((change) => __awaiter(void 0, void 0, void 0, function* () {
                            console.log(JSON.stringify({
                                before_exists: change.before.exists,
                                after_exists: change.after.exists,
                            }));
            ...
            it("should provide DocumentSnapshot for firestore.onDelete()", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onDelete, () => {
                    require("firebase-admin").initializeApp();
                    return {
                        function_id: require("firebase-functions")
                            .firestore.document("test/test")
                            .onDelete((snap) => __awaiter(void 0, void 0, void 0, function* () {
                            console.log(JSON.stringify({
            ...
            it("should provide DocumentSnapshot for firestore.onCreate()", () => __awaiter(void 0, void 0, void 0, function* () {
                const runtime = InvokeRuntimeWithFunctions(fixtures_1.FunctionRuntimeBundles.onWrite, () => {
                    require("firebase-admin").initializeApp();
                    return {
                        function_id: require("firebase-functions")
                            .firestore.document("test/test")
                            .onCreate((snap) => __awaiter(void 0, void 0, void 0, function* () {
                            console.log(JSON.stringify({
                                snap_exists: snap.exists,
                            }));
                        })),
        ...
        describe("Error handling", () => {
            it("Should handle regular functions for Express handlers", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = fixtures_1.FunctionRuntimeBundles.onRequest;
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    require("firebase-admin").initializeApp();
                    return {
            ...
            it("Should handle async functions for Express handlers", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = fixtures_1.FunctionRuntimeBundles.onRequest;
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    require("firebase-admin").initializeApp();
                    return {
            ...
            it("Should handle async/runWith functions for Express handlers", () => __awaiter(void 0, void 0, void 0, function* () {
                const frb = fixtures_1.FunctionRuntimeBundles.onRequest;
                const runtime = InvokeRuntimeWithFunctions(frb, () => {
                    require("firebase-admin").initializeApp();
                    return {
