...
describe("EmulatorRegistry", () => {
    ...
    it("should not report any running emulators when empty", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should correctly return information about a running emulator", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("once stopped, an emulator is no longer running", () => __awaiter(void 0, void 0, void 0, function* () {
        const name = types_1.Emulators.FUNCTIONS;
        const emu = new fakeEmulator_1.FakeEmulator(name, "localhost", 5000);
        chai_1.expect(registry_1.EmulatorRegistry.isRunning(name)).to.be.false;
        yield registry_1.EmulatorRegistry.start(emu);
