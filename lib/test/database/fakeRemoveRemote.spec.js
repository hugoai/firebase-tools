...
describe("FakeRemoveRemote", () => {
    it("should failed to delete large path /", () => __awaiter(void 0, void 0, void 0, function* () {
        const data = { 1: 11 };
    ...
    it("should sucessfully delete large path /", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should failed to delete large path /1", () => __awaiter(void 0, void 0, void 0, function* () {
        const data = { 1: { a: 3, b: 9, c: 2, d: 3 } };
        const fakeDb = new FakeRemoveRemote(data);
        yield chai_1.expect(fakeDb.deletePath("/1")).to.eventually.eql(false);
        chai_1.expect(fakeDb.data).eql(data);
    }));
    it("should successfully delete path /1/a", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should failed to delete large paths /1/a /1/b", () => __awaiter(void 0, void 0, void 0, function* () {
        const data = { 1: { a: 3, b: 9, c: 2, d: 3 } };
        const fakeDb = new FakeRemoveRemote(data);
        yield chai_1.expect(fakeDb.deleteSubPath("/1", ["a", "b"])).to.eventually.eql(false);
        chai_1.expect(fakeDb.data).eql(data);
    }));
    it("should successfully delete multi paths /1/c /1/d", () => __awaiter(void 0, void 0, void 0, function* () {
        const fakeDb = new FakeRemoveRemote({ 1: { a: 3, b: 9, c: 2, d: 3 } });
