...
describe("cloudRunProxy", () => {
    ...
    it("should error when not provided a valid Cloud Run service ID", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should error when the Cloud Run service doesn't exist", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should resolve a function returns middleware that proxies to the live version", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api_1.cloudRunApiOrigin)
    ...
    it("should resolve to a live version in another region", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should cache calls to look up Cloud Run service URLs", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should pass through normal 404 errors", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api_1.cloudRunApiOrigin)
            .get("/v1alpha1/projects/project-foo/locations/us-central1/services/helloworld")
            .reply(200, { status: { address: { hostname: cloudRunServiceOrigin } } });
        nock(cloudRunServiceOrigin)
    ...
    it("should do nothing on 404 errors with x-cascade", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api_1.cloudRunApiOrigin)
            .get("/v1alpha1/projects/project-foo/locations/us-central1/services/helloworld")
            .reply(200, { status: { address: { hostname: cloudRunServiceOrigin } } });
        nock(cloudRunServiceOrigin)
    ...
    it("should remove cookies on non-private cached responses", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api_1.cloudRunApiOrigin)
            .get("/v1alpha1/projects/project-foo/locations/us-central1/services/helloworld")
            .reply(200, { status: { address: { hostname: cloudRunServiceOrigin } } });
        nock(cloudRunServiceOrigin)
    ...
    it("should add required Vary headers to the response", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api_1.cloudRunApiOrigin)
            .get("/v1alpha1/projects/project-foo/locations/us-central1/services/helloworld")
            .reply(200, { status: { address: { hostname: cloudRunServiceOrigin } } });
        nock(cloudRunServiceOrigin)
    ...
    it("should respond with a 500 error if an error occurs calling the Cloud Run service", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api_1.cloudRunApiOrigin)
            .get("/v1alpha1/projects/project-foo/locations/us-central1/services/helloworld")
            .reply(200, { status: { address: { hostname: cloudRunServiceOrigin } } });
        nock(cloudRunServiceOrigin)
    ...
    it("should respond with a 504 error if a timeout error occurs calling the Cloud Run service", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api_1.cloudRunApiOrigin)
            .get("/v1alpha1/projects/project-foo/locations/us-central1/services/helloworld")
            .reply(200, { status: { address: { hostname: cloudRunServiceOrigin } } });
        nock(cloudRunServiceOrigin)
    ...
    it("should respond with a 504 error if a sockettimeout error occurs calling the Cloud Run service", () => __awaiter(void 0, void 0, void 0, function* () {
        nock(api_1.cloudRunApiOrigin)
            .get("/v1alpha1/projects/project-foo/locations/us-central1/services/helloworld")
            .reply(200, { status: { address: { hostname: cloudRunServiceOrigin } } });
        nock(cloudRunServiceOrigin)
