...
describe("functionsProxy", () => {
    ...
    it("should resolve a function that returns middleware that proxies to a local version", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should respond with a 500 error if an error occurs calling the function", () => __awaiter(void 0, void 0, void 0, function* () {
        nock("https://us-central1-project-foo.cloudfunctions.net")
            .get("/bar/500")
    ...
    it("should respond with a 504 error if a timeout error occurs calling the function", () => __awaiter(void 0, void 0, void 0, function* () {
        nock("https://us-central1-project-foo.cloudfunctions.net")
            .get("/bar/timeout")
    ...
    it("should respond with a 504 error if a sockettimeout error occurs calling the function", () => __awaiter(void 0, void 0, void 0, function* () {
        nock("https://us-central1-project-foo.cloudfunctions.net")
