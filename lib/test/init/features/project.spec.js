...
describe("project", () => {
    ...
    describe("getProjectInfo", () => {
        it("should get correct project info when no project supplied", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = {};
        ...
        it("should set instance and location to undefined when resources not provided", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = {};
        ...
        it("should return correct project info when choosing new project", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = {};
            listProjectsStub.returns([TEST_FIREBASE_PROJECT, ANOTHER_FIREBASE_PROJECT]);
        ...
        it("should return correct project info when choosing not to set up project", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = {};
            listProjectsStub.returns([TEST_FIREBASE_PROJECT, ANOTHER_FIREBASE_PROJECT]);
    ...
    describe("doSetup", () => {
        ...
        it("should set up the correct properties when choosing new project", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = {};
            const setup = { config: {}, rcfile: {} };
            listProjectsStub.returns([TEST_FIREBASE_PROJECT, ANOTHER_FIREBASE_PROJECT]);
            promptStub.returns("[create a new project]");
        ...
        it("should set up the correct properties when not choosing a project", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = {};
            const setup = { config: {}, rcfile: {} };
            listProjectsStub.returns([TEST_FIREBASE_PROJECT, ANOTHER_FIREBASE_PROJECT]);
            promptStub.returns("[don't setup a default project]");
        ...
        it("should set project location even if .firebaserc is already set up", () => __awaiter(void 0, void 0, void 0, function* () {
            const options = {};
