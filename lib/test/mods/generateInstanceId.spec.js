...
describe("generateInstanceId", () => {
    ...
    it("should return modSpec.name if no mod with that name exists yet", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should return modSpec.name plus a random string if a mod named modSpec.name exists", () => __awaiter(void 0, void 0, void 0, function* () {
