...
describe("mods", () => {
    describe("listInstances", () => {
        ...
        it("should return a list of installed mods instances", () => __awaiter(void 0, void 0, void 0, function* () {
            nock(api.modsOrigin)
        ...
        it("should query for more installed mods if the response has a next_page_token", () => __awaiter(void 0, void 0, void 0, function* () {
            nock(api.modsOrigin)
                .get(`/${VERSION}/projects/${PROJECT_ID}/instances`)
                .query(true)
