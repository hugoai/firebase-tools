...
describe("askUserForParam", () => {
    ...
    describe("askForParam", () => {
        ...
        it("should keep prompting user until valid input is given", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("ask", () => {
        ...
        it("should call substituteParams with the right parameters", () => __awaiter(void 0, void 0, void 0, function* () {
            const spec = [testSpec];
