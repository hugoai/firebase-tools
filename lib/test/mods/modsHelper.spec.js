...
describe("modsHelper", () => {
    ...
    describe("getValidInstanceId", () => {
        ...
        it("return modName if it is not used by another instance ", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("prompt the user if modName is already used, and return if the user provides a valid id", () => __awaiter(void 0, void 0, void 0, function* () {
            const modName = "mod-name";
